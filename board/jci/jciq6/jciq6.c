...
int mx6_rgmii_rework(struct phy_device *phydev)
{
	...
	//added KSZ90xx support, taken from Saberlite
...
static iomux_v3_cfg_t const usb_otg_pads[] = {
	//MX6_PAD_EIM_D22__USB_OTG_PWR | MUX_PAD_CTRL(NO_PAD_CTRL), // doesnt have USB PWR EN pin
	MX6_PAD_GPIO_1__USB_OTG_ID | MUX_PAD_CTRL(NO_PAD_CTRL),
	MX6_PAD_KEY_COL4__USB_OTG_OC | MUX_PAD_CTRL(NO_PAD_CTRL), //Over current
};

static iomux_v3_cfg_t const usb_hc1_pads[] = {
	//MX6_PAD_ENET_TXD1__GPIO1_IO29 | MUX_PAD_CTRL(NO_PAD_CTRL), // doesnt have USB PWR EN pin
